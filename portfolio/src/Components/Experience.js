...
function Experience({style, scrollIdentifier}) {
    ...
    const displayExperiences = () => {
        const experiences = [
            {name: "CUNY Hunter College", src: "/pictures/huntercollege.jpeg", label: "Graduated From", date: "Jan. 2020 - May 2023", position: "Bachelor of Arts Computer Science", 
            details: [
            ...
            {name: "JetSweat", src: "/pictures/jetsweat.jpeg", label: "Recently Worked At", date: "May 2022 - Aug.2022", position: "iOS Mobile Developer Intern",
            details: [
    ...
    const displayCertificates = () => {
        const certificates = [
            { name: "PUPPLE", src: "/pictures/certificates/pupplecertificate.png",link: "https://drive.google.com/file/d/1VErro4fP8KpJ2Ba4haJi3TuyHBMm85oq/view"},
            { name: "INTERMEDIATE SWE", src: "/pictures/certificates/swecertificate.png", link: "https://drive.google.com/file/d/1N7-3xudSHRH9v8e2lkkNE-vmqoX4RaOC/view"},
            { name: "IOS", src: "/pictures/certificates/ioscertificate.png", link: "https://drive.google.com/file/d/1JDgMH8B0uZgu0Bjo2iWZhmSErDbtlQuS/view"},
            { name: "ANDROID", src: "/pictures/certificates/androidcertificate.png", link: "https://drive.google.com/file/d/1HZEkoU-_nvpHKCTXecE9nODRUh376d20/view"}
        ]
