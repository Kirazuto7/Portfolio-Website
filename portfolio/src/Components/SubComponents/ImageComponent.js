...
export default function ImageComponent({project, index}) {
    ...
    return(
        <div className={Styles.ImageContainer}>
            <div id={`${project.name}Spinner`} className={Styles.PlaceHolderImage} alt={"spinner"}><div className={Styles.Loading}>Loading...</div><div className={`${Styles.Spinner} ${Animations.Spin}`}/></div>
            {
                index === 0 ?
